...
import PositionList from './PositionsList.component'
...
const PositionsTab = (props) => {
    ...
    let company = null;
    let userIsCompanyRelated = false;
    if(props.userInfo?.relatedEntities?.company){
        company = props.userInfo?.relatedEntities?.company;
        userIsCompanyRelated = true;
    }
